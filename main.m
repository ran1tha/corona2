...
ycr1 = func(t,mean(chain),y0);
plot(t,ycr1(:,3),'-','LineWidth',2)

ycr2 = func(t,TCchain,y0);
plot(t,ycr2(:,3),'-','LineWidth',2)

ycr3 = func(t,HCchain,y0);
plot(t,ycr3(:,3),'-','LineWidth',2)
...
yqr1 = func(t,mean(chain),y0);
plot(t,yqr1(:,3),'-','LineWidth',2)

yqr2 = func(t,TQchain,y0);
plot(t,yqr2(:,3),'-','LineWidth',2)

yqr3 = func(t,HQchain,y0);
plot(t,yqr3(:,3),'-','LineWidth',2)
...
yrh1 = func(t,mean(chain),y0);
plot(t,yrh1(:,1),'-','LineWidth',2)

yrh2 = func(t,bchain,y0);
plot(t,yrh2(:,1),'-','LineWidth',2)

yrh3 = func(t,rchain,y0);
plot(t,yrh3(:,1),'-','LineWidth',2)
...
yri1 = func(t,mean(chain),y0);
plot(t,yri1(:,7),'-','LineWidth',2)

yri2 = func(t,bchain,y0);
plot(t,yri2(:,7),'-','LineWidth',2)

yri3 = func(t,rchain,y0);
plot(t,yri3(:,7),'-','LineWidth',2)
...
y14 = func(t,bchain,y0);
plot(t,y14(:,1),'-','LineWidth',2)

y15 = func(t,rchain,y0);
plot(t,y15(:,1),'-','LineWidth',2)
...
y24 = func(t,bchain,y0);
plot(t,y24(:,7),'-','LineWidth',2)

y25 = func(t,rchain,y0);
plot(t,y25(:,7),'-','LineWidth',2)
...
y31 = func(t,mean(chain),y0);
plot(t,y31(:,3),'-','LineWidth',2)

y32 = func(t,HCchain,y0);
plot(t,y32(:,3),'-','LineWidth',2)

y33 = func(t,TQchain,y0);
plot(t,y33(:,3),'-','LineWidth',2)

y34 = func(t,bchain,y0);
plot(t,y34(:,3),'-','LineWidth',2)

y35 = func(t,rchain,y0);
plot(t,y35(:,3),'-','LineWidth',2)
